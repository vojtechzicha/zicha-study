    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
      <Card className="bg-card/80 backdrop-blur-sm border-0 shadow-lg">
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground mt-1">Hodnoceno: {stats.graded}</p>
        </CardContent>
      </Card>

      <Card className="bg-card/80 backdrop-blur-sm border-0 shadow-lg">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium text-muted-foreground">Studijní průměr</CardTitle>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground mt-1">průměr všech známek</p>
        </CardContent>
      </Card>
      ...
      {variant === "full" && (
        <Card className="bg-card/80 backdrop-blur-sm border-0 shadow-lg">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-muted-foreground">Zapsané známky</CardTitle>

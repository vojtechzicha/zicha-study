          ...
          <div className="flex items-start space-x-6">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center space-x-3 mt-2">
                ...
                <span className="text-muted-foreground">{getStudyFormLabel(study.form)}</span>
                <span className="text-muted-foreground/70">•</span>
                ...
                <div className="relative">
                  ...
                  {study.end_year && new Date().getFullYear() >= study.start_year && new Date().getFullYear() <= study.end_year && (() => {
                    ...
                    return (
                      ...
                      >
                        <div className="w-3 h-3 bg-primary-600 rounded-full border-2 border-card shadow-sm -mt-0.5"></div>
                        <div className="text-xs text-primary-600 dark:text-primary-400 font-medium mt-1 whitespace-nowrap">
                          {currentYear}
                        </div>
                      </div>
                    )
              ...
              {study.public_description && <p className="text-muted-foreground mt-2 max-w-2xl">{study.public_description}</p>}
              {study.last_updated && (
